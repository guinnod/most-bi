		...
		<div className="flex h-screen pb-20">
			<div className="w-1/2 p-20 flex flex-col justify-center  gap-6 ">
				...
				<Link
					...
					className="bg-[#bd302d] py-5 px-8 flex w-40 justify-center items-center rounded-xl hover:bg-[#eb4432]"
				>
			...
			<div className="relative w-1/2">
				<div className="absolute space-y-5 bottom-0 left-0 top-0  z-10 flex flex-col items-center justify-center">
					<div className="flex flex-col items-center justify-center rounded-2xl bg-[#bd302d] shadow-lg  ml-[-70px] w-[170px] py-3 xl:ml-[-115px] xl:w-[230px] xl:py-9">
						<div class="mb-1 text-3xl font-bold text-brand text-white xl:text-4xl">
							4,000
						</div>
						<div class="text-l text-white">funded startups</div>
					</div>
					<div className="flex flex-col items-center justify-center rounded-2xl bg-[#bd302d] shadow-lg  ml-[-70px] w-[170px] py-3 xl:ml-[-115px] xl:w-[230px] xl:py-9">
						<div class="mb-1 text-3xl font-bold text-brand text-white xl:text-4xl">
							$600B
						</div>
						<div class="text-l text-white ">combined valuation</div>
					</div>
				</div>
				<Image
